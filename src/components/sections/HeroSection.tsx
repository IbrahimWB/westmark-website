...
export function HeroSection({ badge, title, subtitle, cta }: Props) {
  ...
  return (
    <section className="hero-bg-root relative overflow-hidden">
      ...
      <div className="relative z-20 mx-auto flex max-w-[1360px] justify-center px-3 pt-3 sm:px-4 sm:pt-4 md:px-5 lg:px-6">
        <div className="flex w-full max-w-[720px] items-center justify-between rounded-2xl border border-[rgba(0,255,220,0.14)] bg-[rgba(6,12,14,0.78)] px-3 py-2.5 shadow-[0_12px_34px_rgba(0,0,0,0.38)] backdrop-blur-md sm:px-4 md:px-6">
          ...
          <a className="text-[13px] font-medium text-white/75 transition hover:text-white/95 sm:text-[14px]" href="#">
            Access the Routing Layer
          </a>
        </div>
      </div>

      <div className="relative z-20 mx-auto flex min-h-[540px] max-w-[1120px] items-center justify-center px-4 pt-14 pb-12 text-center sm:min-h-[620px] sm:pt-20 sm:pb-16 md:px-5 md:pt-24 lg:px-6 lg:pt-28">
        <div
          aria-hidden
        ...
        <div className="w-full">
          <div className="inline-flex items-center rounded-full border border-[rgba(0,225,255,0.34)] bg-[linear-gradient(90deg,rgba(2,34,44,0.82)_0%,rgba(2,52,62,0.74)_100%)] px-5 py-1.5 text-[10px] font-medium tracking-[0.08em] text-[#19dcff] shadow-[inset_0_0_0_1px_rgba(0,255,255,0.08)] sm:px-7 sm:py-2 sm:text-[11px]">
            {badge}
          </div>
          <h1
            className="mx-auto mt-6 max-w-[930px] text-[clamp(34px,9.2vw,84px)] font-[380] leading-[1.04] tracking-[-0.026em] text-white sm:mt-7 sm:tracking-[-0.028em]"
          ...
          <p className="mx-auto mt-4 max-w-[720px] text-[14px] leading-[1.55] text-[rgba(255,255,255,0.62)] sm:mt-5 sm:text-[16px] md:text-[18px]">
            {subtitle}
          </p>
